...
export class SignUpComponent implements OnInit {
    ...
    private physicalAddress: FormControl;
    private country: FormControl;
    private phone: FormControl;
    private email: FormControl;
    private businessName: FormControl;
    private businessNumber: FormControl;
    private dateOfReg: FormControl;
    private regAddress: FormControl;
    private businessEmail: FormControl;
    private businessTel: FormControl;
    private website: FormControl;
    private businessNature: FormControl;
    ...
    ngOnInit() {
        ...
        this.businessEmail = new FormControl('', [Validators.required, Validators.email]);
        this.businessTel = new FormControl('', [Validators.required]);
        this.website = new FormControl('', [Validators.required]);
        this.businessNature = new FormControl('', [Validators.required, Validators.maxLength(400)]);
